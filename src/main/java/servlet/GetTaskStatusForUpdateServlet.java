...
@WebServlet(urlPatterns = "/getTaskStatus")
public class GetTaskStatusForUpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) {
        ...
        try {
            ...
            req.getRequestDispatcher("/WEB-INF/updateStatus.jsp").forward(req, resp);
